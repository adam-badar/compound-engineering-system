...
4. If PR head SHA changes at any time (new push/force-push), invalidate prior gate result and rerun triple review with the new head SHA before making merge decisions.
