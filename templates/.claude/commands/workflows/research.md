...
- still deciding WHAT: `/workflows:brainstorm "<topic>"`
- ready to define HOW: `/workflows:plan-loop "<topic or plan path>"`
- existing plan needs deeper grounding: `/workflows:deepen-plan "<plan-path>"`
