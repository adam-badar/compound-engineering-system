...
- `architecture-strategist` for system-level decision rationale
- `kieran-python-reviewer` for Python behavior details
- `security-sentinel` for auth/trust logic questions
- `performance-oracle` for perf tradeoff questions
...
- planning needed: `/workflows:plan-loop "<problem>"`
- direct execution on approved scope: `/workflows:work <plan-path>`
